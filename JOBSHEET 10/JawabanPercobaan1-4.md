...
13. Apa fungsi dari String.join()?
  ...
  Jawban percobaan 1
Percobaan 1
1. Tidak, namun ditulis secara berurutan membuat lebih rapi
2. Karena elemen [3][1] belum di isi
3. Sudah
4. Karena elemen pertama penonton diisi dengan 4, sedangkan elemen ke 2 diisi dengan 2
5. Sudah
6. Sudah
7. Sudah
8. Sudah
9. Sudah
10. Foreach lumayan susah dipahami bagi pemula secara logika namun kode tersebut juga terasa sangat efisien
11. 3 karena berelemen 4
12. 1 karena berelemen 2
13. Saat di S.O.P akan langsung menampilkan isi elemen 
...
Jawaban Percobaan 2
1. Tidak, hanya karena elemen sudah disiapkan bukan berarti harus diisi bahkan berurutan
2. Sudah
3. Sudah
4. Sudah
5. Sudah
...
Jawaban Percobaan 3
1. Sudah
2. Menampilkan array secara utuh sesuai isi elemen(bukan berupa kode)
3. 0
4. Sudah
5. Tidak
